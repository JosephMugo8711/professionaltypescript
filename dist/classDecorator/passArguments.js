...
function addMetadata1(metadata) {
    return function log(target) {
        target.__customMetadata = metadata;
        return target;
    };
}
let Person1 = (() => {
    let _classDecorators = [addMetadata1({ guid: "417c6ec7-ec05-4954-a3c6-73a0d7f9f5bf" })];
...
function getMetadataFromClass1(target) {
    return target.__customMetadata;
}
console.log(getMetadataFromClass1(Person1));
{
